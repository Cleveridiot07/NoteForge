  ...
  return (
    <>
        <div
                ...
                >
                {showButton && (<><div
                    className="absolute top-3 p-1.5 right-2 z-30 mx-auto w-[30px] h-[30px] bg-white/80 py-3 shadow backdrop-blur-lg md:bottom-6 md:rounded-full flex items-center justify-center cursor-pointer text-2xl text-red-500 hover:bg-rose-100 hover:text-white"
                ...
                <div
                    className="absolute bottom-1 right-2 z-30 mx-auto p-1 w-[30px] h-[30px] border border-gray-100 bg-white/80 py-3 shadow backdrop-blur-lg md:bottom-6 md:rounded-full flex items-center justify-center cursor-pointer text-2xl text-red-500 hover:bg-emerald-100 hover:text-white"
                    onClick={handleEdit}
                >
                ...
                <span className={`absolute top-10 z-0 h-20 w-20 rounded-full bg-${props.color}-500 transition-all duration-300 group-hover:scale-[100]`}></span>
                <div className="relative z-10 mx-auto max-w-md">
                    <span className={`grid h-20 w-20 place-items-center rounded-full bg-${props.color}-500 transition-all duration-300 group-hover:bg-${props.color}-400`}>
